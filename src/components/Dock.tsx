...
function DockItem({
  ...
  return (
    <motion.div
      ...
      onClick={() => {
        onClick && onClick();
        mouseX.set(Infinity); // bosilgandan keyin ikonani boshlang‘ich holatga qaytaradi
      }}
  ...
  return (
    <motion.div style={{ height, scrollbarWidth: 'none' }} className="mx-2  flex max-w-full items-center">
      <motion.div
        ...
        onMouseLeave={() => {
          isHovered.set(0);
          mouseX.set(Infinity); // hover tugaganda ikonani yana boshlang‘ich holatga qaytaradi
        }}
      ...
      >
        {items.map((item, index) => (
          <DockItem
            ...
            onClick={() => {
              item.onClick();
              mouseX.set(Infinity); // bosilgandan keyin ham qaytarish
            }}
