...
export const portfolioData = [
  {
    ...
    fullDescription:
      "Mehmonxona — bu tashrif buyuruvchilar birinchi taassurotni hosil qiladigan joy. Shuning uchun har bir detal iliqlik, qulaylik va nafislik uyg'unligida yaratildi. Har bir mehmonga uydek iliq tuyg'u bag'ishlaydigan dizayn.",
    category: "Mehmonxona",
    date: "2024",
...
`,
  ...
  },
  {
    ...
    mainImage: "/15.1.jpg",
    title:
      "Zamonaviy va noodatiy sanuzel — maksimal qulaylik va estetik uyg‘unlik",
...
`,
  ...
  },
  {
    ...
    mainImage: "/16.1.jpg",
    title:
      "Zamonaviy va noodatiy mehmonxona — iliqlik, qulaylik va estetik uyg‘unlik",
    shortDescription:
      "O‘ziga xos, zamonaviy va mehmonlarni hayratda qoldiradigan mehmonxona interyeri",
    fullDescription: `
...
har kuni sizni va mehmonlaringizni iliq kutib oladigan makon yaratadi.
  ...
  },
  {
    ...
    fullDescription:
      "Yotoqxona – bu dam olish va xotirjamlik maskani. Ortiqcha bezaklarsiz, faqat kerakli narsalar bilan to'ldirilgan makon sizga ichki tinchlikni his qilishga yordam beradi. Zamonaviy minimalistik dizayn orqali biz uyingizga tinchlik va tartib olib kelamiz.",
    category: "Yotoqxona",
    date: "2024",
  ...
  },
  {
    ...
    fullDescription:
      "O'zingizga berilgan eng yaxshi sovg'a. Tashvishlardan yiroq, tartibli va toza joy — haqiqiy dam olish manzili. Har bir element diqqat bilan tanlab, sizning qulayligingiz uchun mo'ljallangan.",
    category: "Yotoqxona",
    date: "2024",
  ...
  },
  {
    ...
    fullDescription:
      "Tartibli va zamonaviy oshxona — eng yaxshi tanlov. Biz sizga faqat go'zal ko'rinish emas, balki kundalik hayotingizni soddalashtiradigan amaliy yechimlarni taklif qilamiz.",
    category: "Oshxona",
    date: "2024",
  ...
  },
  {
    ...
    fullDescription:
      "Hojatxona dizayni haqida o'ylayotganda, uni oddiygina texnik xona deb o'ylamang. To'g'ri tanlangan ranglar, dekor va sanitariya jihozlari yordamida bu joyni zamonaviy makonga aylantirish mumkin.",
    category: "Sanuzel",
    date: "2024",
  ...
  },
  {
    ...
    fullDescription:
      "Biz siz orzu qilgan oshxonani yaratamiz: zamonaviy, qulay, chiroyli va har kuni ilhom baxsh etadigan.",
    category: "Oshxona",
    date: "2024",
  ...
  },
  {
    ...
    fullDescription:
      "Klassik uslub — bu nafislik, uyg'unlik va vaqt sinovidan o'tgan go'zallik uyg'unligidir.",
    category: "Eksteryer",
    date: "2024",
  ...
  },
  {
    ...
    fullDescription:
      "Uyingiz yoki binongizning tashqi ko'rinishi siz haqingizda ko'p narsani aytadi.",
    category: "Eksteryer",
    date: "2024",
  ...
  },
  {
    ...
    fullDescription:
      "Agar siz hashamatdan yiroq, ammo chiroyli va zamonaviy eksteryer istasangiz — bu uslub aynan siz uchun.",
    category: "Eksteryer",
    date: "2024",
  ...
  },
  {
    ...
    fullDescription:
      "Agar siz zamonaviy, oson tozalanadigan va qulay sanuzel yaratmoqchi bo'lsangiz — bizning dizayn variantlarimiz aynan shunday talablarni qondiradi.",
    category: "Sanuzel",
    date: "2024",
    images: [
      "/9.1.jpg",
  ...
  },
  {
    ...
    fullDescription:
      "Agar siz oddiy, ammo estetik jihatdan nafis va tinchlantiruvchi yotoqxona yaratmoqchi bo'lsangiz, minimalizm uslubi aynan siz uchun!",
    category: "Yotoqxona",
    date: "2024",
